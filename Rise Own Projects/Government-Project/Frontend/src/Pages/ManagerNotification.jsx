        ...
        <div className="w-[350px] ml-[35%]  shadow-lg  h-[540px] rounded-[20px] bg-white ">
            <form className="pt-4 ">
                <div className="flex ">
                    ...
                    <h1 className=" text-center text-skyBlue ml-[80px] font-semibold font-Roboto text-[25px]">Recent Notification </h1>
                </div>
                <div className="px-6 mt-3">
                    ...
                    <div className="flex  gap-10 justify-between px-[20px]">
                        <button className="w-[100px] h-[40px] text-white bg-deepBlue hover:bg-skyBlue rounded-[10px] mt-3" placeholder="Enter Permission Reason"> Accept</button>
                        <button className="w-[100px] h-[40px] text-white bg-deepBlue hover:bg-skyBlue rounded-[10px] mt-3" placeholder="Enter Permission Reason"> Reject</button>
                    </div>
                </div>
